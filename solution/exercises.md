...
>   1. *"Trả lời ngắn gọn, dùng gạch đầu dòng":* Vì trợ lý chạy trên terminal có không gian hẹp, câu trả lời ngắn gọn và chia ý rõ ràng sẽ giúp học viên dễ đọc, không phải cuộn màn hình nhiều và cũng tiết kiệm đáng kể token đầu ra.
>   2. *"Giải thích bằng tiếng Việt dễ hiểu":* Giúp người học tiếp thu kiến thức tự nhiên, đồng thời ngăn model tự động chuyển sang tiếng Anh khi gặp các thuật ngữ kỹ thuật phức tạp.
